...
app.use(cors({ origin: 'http://107.21.13.239:3000', credentials: true }));

//use express session to maintain session data
app.use(session({
    secret              : 'cmpe272_kafka_passport_mongo',
...
app.use(function(req, res, next) {
    res.setHeader('Access-Control-Allow-Origin', 'http://107.21.13.239:3000');
